import dfs from "components/algorithm/dfs";
...
const Dfs = ({ start, end }) => {
  ...
  const handleClick = async () => {
    ...
    const isFindElement = await dfs(grid, setGrid, start, end);
  ...
  return (
    <div className="h-full">
      <div className="text-4xl text-center mb-4">Depth First Search</div>
